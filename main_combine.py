...
source_train_fid = "/dlummkd/mr_train_list"
source_val_fid = "/dlummkd/mr_val_list"

target_train_fid = "/dlummkd/ct_train_list"
target_val_fid = "/dlummkd/ct_val_list"
